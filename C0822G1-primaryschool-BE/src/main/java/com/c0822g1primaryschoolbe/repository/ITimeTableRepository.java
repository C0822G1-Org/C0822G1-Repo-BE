...
public interface ITimeTableRepository extends JpaRepository<Student, Long> {
    ...
    @Query(value = "select lesson.lesson_name as nameLesson, day.day_name as nameDay, subject.subject_name as nameSubject from time_table tt\n" +
            ...
            "order by day.day_name, lesson.lesson_name", nativeQuery = true, countQuery = "select lesson.lesson_name, day.day_name, subject.subject_name from time_table tt\n" +
            "join day on day.day_id = tt.day_id\n" +
            "join lesson on lesson.lesson_id = tt.lesson_id\n" +
            "join time_table_subject tts on tts.time_table_id = tt.time_table_id\n" +
            "join subject on tts.subject_id = subject.subject_id\n" +
